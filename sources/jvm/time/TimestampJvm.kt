...
actual fun Timestamp.toLocalDate(timeZone: TimeZone) =
	toPlatform().atZone(timeZone.platform).toLocalDate().toCommon()


actual fun Timestamp.toLocalDateTime(timeZone: TimeZone) =
	toPlatform().atZone(timeZone.platform).toLocalDateTime().toCommon()


actual fun Timestamp.toLocalTime(timeZone: TimeZone) =
	toPlatform().atZone(timeZone.platform).toLocalTime().toCommon()
